...
from home.models import user_data, Student
...
def index(request):
    if request.session.get('is_login', None):
        student = User.objects.get(id=int(request.session.get('user_id', None)))
        if student:
            return render(request, 'login/index.html', {'student': student})
